...
export default function ProductCard({ product }: { product: Product }) {
    ...
    return (
        <>
            <div className="border p-4 rounded-md shadow-md flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">  
                <div>
                    <h2 className="
                        text-xl text-secondary font-bold mb-2
                        flex flex-col gap-1
                ...
                ">
                    ...
                    <button 
                        className="text-blue-500 hover:text-blue-700 cursor-pointer hover:bg-blue-100 rounded-full flex items-center justify-center w-8 h-8"
                    ...
                    <button 
                        className="text-red-500 hover:text-red-700 cursor-pointer hover:bg-red-100 rounded-full flex items-center justify-center w-8 h-8"
